...
public class CosmicVersionPreferenceController extends PreferenceController {
    ...
    public boolean isAvailable() {
        return !TextUtils.isEmpty(SystemProperties.get(PROPERTY_COSMIC_VERSION));
    }

    @Override
    public void displayPreference(PreferenceScreen screen) {
        super.displayPreference(screen);
        final Preference pref = screen.findPreference(KEY_COSMIC_VERSION);
        if (pref != null) {
            final String summary = SystemProperties.get(PROPERTY_COSMIC_VERSION,
                    mContext.getResources().getString(R.string.cosmic_version_default));
